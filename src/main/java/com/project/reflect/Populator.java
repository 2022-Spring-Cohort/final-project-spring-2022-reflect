...
public class Populator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Article article3 = new Article("Five Ways Mindfulness Meditation Is Good for Your Health", "Jill Suittie", "./images/tibetan-bowl.png",
        ...
        Article article4 = new Article("Mindfulness Makeover: How To 'Just Be' No Matter What", "Sarah Jeanne Browne", "./images/tibetan-bowl.png",
        ...
        Article article5 = new Article("6 Ways to Practice Mindful Eating", "Christopher Willard", "./images/tibetan-bowl.png",
